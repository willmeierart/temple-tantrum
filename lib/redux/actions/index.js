...
export const checkIfMobile = () => async dispatch => {
  const bool = typeof window !== 'undefined' && typeof window.orientation !== 'undefined'
  dispatch({
...
export const setSponsors = sponsors => async dispatch => {
  dispatch({
    type: SET_SPONSORS,
    payload: sponsors
  })
...
export const hoverCursor = bool => async dispatch => {
  dispatch({
    type: HOVER_CURSOR,
    payload: bool
  })
